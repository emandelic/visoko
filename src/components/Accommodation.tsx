...
const accommodations: Accom[] = [
  {
    name: "ANET Apartman Visoko",
    type: "Apartments",
    rating: 9.9,
    ratingLabel: "Exceptional",
    reviewCount: 52,
    distanceKm: 0.5,
    distanceLabel: "Walking distance to Pyramid of the Sun",
    address: "Novo Naselje, 71300 Visoko",
    description: "Modern, spacious apartment with brand new furniture, beautiful terrace and garden views toward the pyramid. Perfect quiet location. Hosts are extremely helpful. Rated 9.9/10.",
    amenities: ["Free WiFi", "Balcony", "Terrace", "Kitchen", "Parking"],
    priceRange: "€30–€60 / night",
    bookingUrl: "https://www.booking.com/hotel/ba/anet-apartman-visoko.html",
    photos: ["/images/apartments/apt1-interior.jpg", "/images/pyramids/pyramid-sun.jpg", "/images/pyramids/visoko-town.jpg", "/images/pyramids/pyramid-hill.jpg"],
    badge: "Exceptional 9.9",
    badgeColor: "#4a9aca",
  },
  {
    ...
    photos: ["/images/apartments/apt2-building.jpg", "/images/apartments/apt2-room.jpg", "/images/pyramids/pyramid-sun.jpg", "/images/pyramids/ravne-tunnel-k2.jpg"],
    badge: "Pyramid View",
    badgeColor: "#C9A84C",
  },
  {
    ...
    photos: ["/images/apartments/apt3-exterior.jpg", "/images/apartments/apt3-garden.jpg", "/images/pyramids/pyramid-sun.jpg", "/images/pyramids/visoko-town.jpg"],
    badge: "Exceptional 9.4",
    badgeColor: "#4a9aca",
  },
  {
    name: "Becar Pyramid Rooms",
    type: "Apartments",
    rating: 9.7,
    ratingLabel: "Exceptional",
    reviewCount: 159,
    distanceKm: 0.2,
    distanceLabel: "Steps from Pyramid of the Sun",
    address: "Mule Hodžića bb, 71300 Visoko",
    description: "Spotlessly clean new rooms on the main road leading directly to the Pyramid of the Sun and Moon. Excellent breakfast, private parking, free WiFi. Rated 10/10 for cleanliness.",
    amenities: ["Free WiFi", "Breakfast", "Parking", "Air conditioning", "Garden"],
    priceRange: "€25–€50 / night",
    bookingUrl: "https://www.booking.com/hotel/ba/becar-pyramid-rooms.html",
    photos: ["/images/apartments/apt2-room.jpg", "/images/apartments/apt3-exterior.jpg", "/images/pyramids/pyramid-sun.jpg", "/images/pyramids/ravne-tunnel-k2.jpg"],
    badge: "Most Reviews",
    badgeColor: "#6aaa6a",
  },
];
